...
public class PrestamoPersonalDTO {
    ...
    public PrestamoPersonalDTO(int idPrestamo, Date fechaOtorgamiento, double montoSolicitado, int plazoMeses, double tasaAnual, Cliente cliente, List<Cuota> cuotas) {
